<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ContactPagePartialTemplate.ascx.cs" Inherits="AlloyEPiServerSite.Views.Pages.Partials.ContactPagePartialTemplate" %>
