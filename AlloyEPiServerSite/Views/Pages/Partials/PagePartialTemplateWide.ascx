<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="PagePartialTemplateWide.ascx.cs" Inherits="AlloyEPiServerSite.Views.Pages.Partials.PagePartialTemplateWide" %>
