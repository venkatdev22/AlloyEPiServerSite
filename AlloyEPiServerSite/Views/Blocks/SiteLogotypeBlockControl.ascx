<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="SiteLogotypeBlockControl.ascx.cs" Inherits="AlloyEPiServerSite.Views.Blocks.SiteLogotypeBlockControl" %>
